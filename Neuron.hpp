...
class Neuron{
	...
	public:
		 ...
		 * no getter because cannot have a satic method that is const
		 */
        ...
        */
		...
		std::vector<unsigned int> getOutcomingConnexions() const; /**< @return  the coutcoming connexion of a neuron */
