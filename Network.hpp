...
class Network{
	...
	public:
		/**
		 * static constant of the class Network, need to be accessible from outside, no getters becuase cannot have static methods that are const
		*/
		...
		static constexpr unsigned int nb_connex_inhib_=0.1*nb_inhib_; /**< nb_connex_inhib_ = Number ofinhibitory connexion of one neuron -> nb_inhib_*10%=250 */
		 ...
		 * it asscribes the amplitude of the postsynaptic weight corresponding to the nature of the neuron (excitatory or inhibitory)
		 *@see targets_
		 *@see weights_
		*/
		Network();
		...
		*/
		...
		/**
		 * The update methode of my network
	...
	private:
		 ...
		 * the line targets_[i] contains the indice of all the neurons that send postsynaptic weight to neuron i
		*/
